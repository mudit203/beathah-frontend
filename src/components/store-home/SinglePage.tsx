...
interface SinglePageSettingProps {
  isSave: boolean;
  register: UseFormRegister<any>;
  errors: FieldErrors<any>;
  isSubmitting: boolean;
  singleProductPageRightBox: boolean;
  setSingleProductPageRightBox: (checked: boolean) => void;
}

const SinglePageSetting: React.FC<SinglePageSettingProps> = ({
  isSave,
  register,
  errors,
  isSubmitting,
            ...
            >
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-4">
                ...
                <div className=" sm:col-span-4">
                  ...
                  <Error errorName={typeof errors.slug_page_card_description_one?.message === 'string' ? { message: errors.slug_page_card_description_one.message } : undefined} />
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-4">
                ...
                <div className=" sm:col-span-4">
                  ...
                  <Error errorName={typeof errors.slug_page_card_description_two?.message === 'string' ? { message: errors.slug_page_card_description_two.message } : undefined} />
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-4">
                ...
                <div className=" sm:col-span-4">
                  ...
                  <Error errorName={typeof errors.slug_page_card_description_three?.message === 'string' ? { message: errors.slug_page_card_description_three.message } : undefined} />
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-4">
                ...
                <div className=" sm:col-span-4">
                  ...
                  <Error errorName={typeof errors.slug_page_card_description_four?.message === 'string' ? { message: errors.slug_page_card_description_four.message } : undefined} />
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-4">
                ...
                <div className="sm:col-span-4">
                  ...
                  <Error errorName={typeof errors.slug_page_card_description_five?.message === 'string' ? { message: errors.slug_page_card_description_five.message } : undefined} />
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-4">
                ...
                <div className=" sm:col-span-4">
                  ...
                  <Error errorName={typeof errors.slug_page_card_description_six?.message === 'string' ? { message: errors.slug_page_card_description_six.message } : undefined} />
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-4">
                ...
                <div className=" sm:col-span-4">
                  ...
                  <Error errorName={typeof errors.slug_page_card_description_seven?.message === 'string' ? { message: errors.slug_page_card_description_seven.message } : undefined} />
                </div>
              </div>
            </div>
          </div>
