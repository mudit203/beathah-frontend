...
interface PrivacyPolicyProps {
  ...
  setTextEdit: (state: EditorState) => void;
  privacyPolicy: boolean;
  setPrivacyPolicy: (checked: boolean) => void;
  setPrivacyPolicyHeaderBg: (url: string) => void;
  privacyPolicyHeaderBg: string;
  setTermsConditions: (checked: boolean) => void;
  termsConditions: boolean;
  setTermsConditionsHeaderBg: (url: string) => void;
  termsConditionsHeaderBg: string;
  termsConditionsTextEdit: EditorState;
  setTermsConditionsTextEdit: (state: EditorState) => void;
          ...
          >
            ...
            <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3 relative">
              ...
              <div className="sm:col-span-4">
                ...
                />
                <Error errorName={typeof errors.privacy_page_title?.message === 'string' ? { message: errors.privacy_page_title.message } : undefined} />
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
              ...
              <div className="sm:col-span-4">
                <InputAreaTwo
                  ...
                  placeholder={t("PageTitle")}
                />
                <Error errorName={typeof errors.termsConditions_page_title?.message === 'string' ? { message: errors.termsConditions_page_title.message } : undefined} />
              </div>
            </div>
