...
const StoreHome: React.FC = () => {
  ...
  const tabName = searchParams.get("storeTab");
    ...
    <>
      ...
      <>
        <ul className="sm:flex grid grid-cols-3 text-sm font-medium text-center text-gray-500 sm:divide-x divide-gray-200 rounded-lg dark:divide-gray-700 dark:text-gray-400 mb-5">
          <li>
            <Link
              href={{ pathname: "/store/customization", query: { storeTab: "home-settings" } }}
              className={`inline-block w-full px-4 py-3 shadow-md ${
                tabName === "home-settings" || !tabName
            ...
            >
              ...
              <span className="text-sm font-medium font-serif xl:hidden">
                {tabName === "home-settings" || !tabName ? "Home" : "Home"}
              </span>
            </Link>
          </li>
          <li>
            <Link
              href={{ pathname: "/store/customization", query: { storeTab: "single-setting" } }}
          ...
          <li>
            <Link
              href={{ pathname: "/store/customization", query: { storeTab: "about-us-setting" } }}
              className={`inline-block w-full py-3 px-4 shadow-md ${
          ...
          <li>
            <Link
              href={{ pathname: "/store/customization", query: { storeTab: "privacy-setting" } }}
              className={`inline-block w-full py-3 px-4 shadow-md ${
          ...
          <li>
            <Link
              href={{ pathname: "/store/customization", query: { storeTab: "FAQ-setting" } }}
              className={`inline-block w-full py-3 px-4 shadow-md ${
                tabName === "FAQ-setting"
                  ? "bg-emerald-500 text-white dark:bg-emerald-500 dark:text-white"
                  : "bg-gray-200 text-gray-800 font-medium dark:bg-gray-600 dark:text-gray-300"
          ...
          <li>
            <Link
              href={{ pathname: "/store/customization", query: { storeTab: "offers-setting" } }}
              className={`inline-block w-full py-3 px-4 shadow-md ${
          ...
          <li>
            <Link
              href={{ pathname: "/store/customization", query: { storeTab: "contact-us-setting" } }}
              className={`inline-block w-full py-3 px-4 shadow-md ${
          ...
          <li>
            <Link
              href={{ pathname: "/store/customization", query: { storeTab: "checkout-setting" } }}
              className={`inline-block w-full py-3 px-4 shadow-md ${
          ...
          <li>
            <Link
              href={{ pathname: "/store/customization", query: { storeTab: "dashboard-setting" } }}
              className={`inline-block w-full py-3 px-4 shadow-md ${
          ...
          <li>
            <Link
              href={{ pathname: "/store/customization", query: { storeTab: "seo-settings" } }}
              className={`inline-block w-full py-3 px-4 shadow-md ${
